  ...
  return (
    <div className="hero-visual relative mx-auto w-full max-w-[560px]">
      <GlassCard className="p-5 sm:p-6">
        <div className="relative overflow-hidden rounded-[8px] border border-white/60 bg-white/28 p-5 shadow-sm backdrop-blur-2xl">
          <div className="pointer-events-none absolute -right-10 -top-10 h-64 w-64 rounded-full bg-blue-400/10 blur-3xl" />
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={label} className="rounded-[8px] border border-white/60 bg-white/34 p-4 shadow-sm backdrop-blur-xl">
          ...
          <div className="mt-5 rounded-[8px] border border-white/60 bg-white/34 p-4 shadow-sm backdrop-blur-xl">
          ...
          <div className="mt-5 flex items-center gap-3 rounded-[8px] border border-blue-100/80 bg-blue-50/48 px-4 py-3 backdrop-blur-xl">
